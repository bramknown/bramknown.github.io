    ...
    (function(c, x) {
        ...
        function B(a, b, e, m, d) {
            ...
            if (h)
                ...
                B(d, b, e, "", function(a) {
                    return a
                })) : null != d && (M(d) && (d = oa(d, e + (!d.key || h && h.key === d.key ? "" : ("" + d.key).replace(da, "$&/") + "/") + a)),
                b.push(d)),
                1;
            h = 0;
            m = "" === m ? "." : m + ":";
        ...
        t = {
            ...
            Scheduler: {
                ...
                unstable_scheduleCallback: function(a, b, c) {
                    ...
                    c = "number" === typeof c && 0 < c ? e + c : e) : c = e;
                    switch (a) {
                    case 1:
                        var d = -1;
                        break;
                    ...
                    c > e ? (a.sortIndex = c,
                    O(r, a),
                    null === p(q) && a === p(r) && (z ? (ea(A),
                    A = -1) : z = !0,
                    T(Q, c - e))) : (a.sortIndex = d,
                    O(q, a),
                    u || F || (u = !0,
                    R(S)));
                    return a
